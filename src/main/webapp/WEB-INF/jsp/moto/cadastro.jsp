...
<div class="container mt-3">
    ...
    <form action="/moto/incluir" method="post">
        ...
        <div class="form-check">
            <input class="form-check-input" type="checkbox" name="partidaeletrica" value="true" checked>
            <label class="form-check-label">Tem partida eletrica?</label>
        </div>
