...
<div class="container mt-3">
    ...
    <form action="/carro/incluir" method="post">
        ...
        <div class="form-check">
            <input class="form-check-input" type="checkbox" name="arcondicionado" value="true" checked>
            <label class="form-check-label">Tem ar condicionado?</label>
        </div>
